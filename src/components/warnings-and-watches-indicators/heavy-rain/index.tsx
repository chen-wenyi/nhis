import styles from './heavy-rain.module.css';

type HeavyRainLevel = 'watch' | 'warning' | 'red warning';

interface HeavyRainProps {
  level: HeavyRainLevel;
}

export function HeavyRain({ level }: HeavyRainProps) {
