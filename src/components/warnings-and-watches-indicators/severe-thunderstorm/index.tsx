import styles from './severe-thunderstorm.module.css';

export type SevereThunderstormLevel = 'watch' | 'warning' | 'red warning';

interface SevereThunderstormProps {
  level: SevereThunderstormLevel;
}

export function SevereThunderstorm({ level }: SevereThunderstormProps) {
  ...
  return (
    <div className={`${styles.container} ${getColorClass()}`}>
      ...
      <div className={`${styles.imageWrapper} ${getImageWrapperClass()}`}>
        <img
          src="/watches_warnings/thunderstorm.png"
          alt="Severe thunderstorm icon"
